...
export default function CartReceipt() {
  ...
  return (
    <div className="border border-stroke-secondary rounded-lg p-6 w-full max-w-sm mx-auto flex flex-col h-full">
      ...
      <div className="flex justify-between font-semibold text-sm mb-12">

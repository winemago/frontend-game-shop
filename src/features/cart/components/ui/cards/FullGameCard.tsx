...
export default function GameFullCard({ game, onRemove }: GameFullCardProps) {
  return (
    <div className="relative flex sm:flex-col md:flex-row gap-4 mb-4 items-start md:items-center">
      <div className="flex gap-4 flex-row w-full md:flex-row">
        <div className="sm:w-[20px] md:w-[120px] h-[160px] md:h-[80px] relative shrink-0">
          <Image
            src={game.image}
            alt={game.name}
            width={120}
